...
Hermes VM, all mock kinds). The legacy delivery pipeline (shadow trees,
package shims, isolated bundles, `HT_RESOLVER=legacy`) was removed in July
2026 after the plugin resolver soaked in production.
