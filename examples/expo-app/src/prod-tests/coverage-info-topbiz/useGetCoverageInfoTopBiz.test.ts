...
group('useGetCoverageInfoTopBiz', () => {
  test('netbank coverage — default fields', ({ expect }: any) => {
  ...
  test('liability coverage — variable deductible + co-insured', ({ expect }: any) => {
  ...
  test('transport coverage — activities', ({ expect }: any) => {
  ...
  test('machine coverage — details list', ({ expect }: any) => {
  ...
  test('business interruption — coverage period', ({ expect }: any) => {
  ...
  test('occupational statutory — max per employee + per accident', ({ expect }: any) => {
  ...
  test('movable property — default + coverage details', ({ expect }: any) => {
